"use client";
import menuData from "@/app/random-menu/menus.json";
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="nm-flat p-8 rounded-[2.5rem] flex flex-col h-full">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-6 min-h-[3.5rem]">
          ...
          <div className="nm-flat p-8 rounded-[2.5rem] flex flex-col h-full">
            <div className="mb-6">
              <span className="nm-inset text-orange-500 text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest">
                Sena
              </span>
            </div>
            <h3 className="text-2xl font-bold text-slate-800 mb-6 min-h-[3.5rem]">
